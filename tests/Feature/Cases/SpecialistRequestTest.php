...
/**
 * Three of the five things a visitor can ask for used to be answered with a
 * page saying the online Will service is not available. Summit's handoff of
 * 26 August is blunt that this must never happen again: DIFC completes the
 * whole questionnaire and gets a no-payment review ticket, and the other two
 * open a request form that captures the lead.
 */
...
it('keeps a DIFC request inside the questionnaire', function () {
    // Summit calls this non-negotiable: DIFC answers every question first.
    chooseService('difc');
